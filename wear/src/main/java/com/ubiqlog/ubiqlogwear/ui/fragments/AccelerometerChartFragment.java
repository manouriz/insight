 ...
 */
public class AccelerometerChartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Log.i("AccelerometerChart", "in onCreateView");
    ...
    private void getData()
    {
        ...
        try {
            ...
            Log.i("AccelerometerChartFragment", "logFile =" + logFile);
            if (logFile != null) {
                ...
                while ((read = bufferedReader.readLine()) != null) {
                    ...
                    if (jsonObject1.optJSONObject("Accelerometer") != null) {

                        JSONObject batteryObject = jsonObject1.optJSONObject("Accelerometer");

                        Long x = batteryObject.getLong("acceleration x-axis");
                        Long y = batteryObject.getLong("acceleration y-axis");
                        Long z = batteryObject.getLong("acceleration z-axis");
                        xList.add(x);
                        yList.add(y);
                        zList.add(z);
                        ...
                        Log.i("AccelerometerChartFragment", "x =" + x + ", y = " + y + ", z = " + z);
                        Log.i("AccelerometerChartFragment", "Date =" + date);
                    }
                }
    ...
    private View createGraph() {
        Log.i("AccelerometerChart", "In Create Chart");
